...
interface HardwareSignerFactory : NativeSignerFactory {
	...
	override fun createSigner(
		...
		return if (keyMaterial is KeyMaterial.Local.HardwareBacked) {
			getHardwareSigner(keyMaterial.deviceKeyReference)
		} else null
	}
}

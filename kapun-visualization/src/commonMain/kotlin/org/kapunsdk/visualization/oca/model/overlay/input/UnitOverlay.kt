...
@Serializable
data class UnitOverlay(
	@SerialName("metric_system") val metricSystem: String,
	@SerialName("attribute_units") val attributeUnits: Map<AttributeName, String>,
	...
	fun getUnit(attributeName: AttributeName) = attributeUnits[attributeName]

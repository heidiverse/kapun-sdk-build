...
@Serializable
data class EntryCodeOverlay(
	@SerialName("attribute_entry_codes") val attributeEntryCodes: Map<AttributeName, EntryCodeValue>,
	@SerialName("capture_base") override val captureBase: SAID,
	@SerialName("type") override val type: String = "spec/overlays/entry_code/1.0",
